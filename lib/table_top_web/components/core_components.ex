defmodule TableTopWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TableTopWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TableTopWeb.Gettext, "errors", msg, opts)
    end
  end
